...
while true do
    local playerSelected = readAddress(8, 0x01093FAC, baseAddress, 0x50, 0x4, 0x8, 0x8, 0x34);
    local multiPlayerSelected = readAddress(8, 0x0100CCA8, baseAddress, 0x30, 0x168, 0x16C, 0xC, 0x38, 0x2C);
    local goTitle = readAddress(8, 0x01093FAC, baseAddress, 0x40, 0x0, 0x8, 0x8, 0x6C)
