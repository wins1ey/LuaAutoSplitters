process('WildGunsReloaded.exe')

local prevPlayerSelected
local prevMultiPlayerSelected

while true do
    local playerSelected = readAddress('byte', 0x01093FAC, 0x50, 0x4, 0x8, 0x8, 0x34);
    local multiPlayerSelected = readAddress('byte', 0x0100CCA8, 0x30, 0x168, 0x16C, 0xC, 0x38, 0x2C);
    local goTitle = readAddress('byte', 0x01093FAC, 0x40, 0x0, 0x8, 0x8, 0x6C)
